...
export default function RegisterPage() {
  ...
  const handleRegister = async (userData: {
    ...
    try {
      ...
      // 3. Store JWT token or redirect to login
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Frogtales</h1>
          <h2 className="text-xl text-gray-600">Create your account</h2>
          <p className="mt-2 text-sm text-gray-600">
            Join our community of academic content creators and readers
          </p>
        </div>
      </div>
